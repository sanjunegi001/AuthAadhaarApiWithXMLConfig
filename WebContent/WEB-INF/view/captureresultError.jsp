<%@ include file="template/header.jsp" %>y>
                              ...
                              <td style="margin-top: 24px;margin-left: 19px;float: left;">
                               <table>
                                  <tr style="line-height: 18px;">
                                     <td><span style="font-weight:bold;font-size: 16px;color: #FB2B2B;">Message:</span></td>
                                     <td><span tyle="color: #AF4949;font-weight: bold;font-size: 14px;">Please Capture Your Finger Properly!</span></td>
                                  </tr>
